...
{
    [CreateAssetMenu(menuName = "DerekToolkit/FSM/Conditions/FSM_Condition_HasMoveVector",fileName = "FSM_Condition_HasMoveVector")]
    public class FSM_Condition_HasMoveVector : FSMBaseCondition
    {
